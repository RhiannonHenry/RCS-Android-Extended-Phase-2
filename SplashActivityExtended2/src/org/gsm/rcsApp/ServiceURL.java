...
public class ServiceURL {
	...
	public static String capabilitiesURL(String username){
		return baseURLGW+"capabilities/"+apiVersion+"/"+Utils.URLEncode(username);
	}
	...
	public static String sendFileURL(String username){
		return baseURLGW+"filetransfer/"+apiVersion+"/"+Utils.URLEncode(username)+"/sessions";
	}
	
	public static String fileTransferStatusURL(String username, String sessionId){
		return baseURLGW+"filetransfer/"+apiVersion+"/"+Utils.URLEncode(username)+"/sessions/"+sessionId+"/status";
	}

	public static String fileTransferSessionURL(String username, String sessionId){
		return baseURLGW+"filetransfer/"+apiVersion+"/"+Utils.URLEncode(username)+"/sessions/"+sessionId;
	}
}
