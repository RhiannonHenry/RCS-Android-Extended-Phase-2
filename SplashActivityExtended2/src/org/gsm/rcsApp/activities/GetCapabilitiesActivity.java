...
public class GetCapabilitiesActivity extends Activity {
	...
	public void onStart() {
		...
		try {
			...
			Log.e("GetCapabilitiesActivity", "Authentication Error: get capabilities");
		}
	}

	private void getCapabilities() throws UnsupportedEncodingException {
...
//			client.setBasicAuth(SplashActivity.userId,SplashActivity.appCredentialPassword, authscope);
	...
	public void setCapabilities(View view) throws UnsupportedEncodingException {
		final String url = ServiceURL.capabilitiesURL(SplashActivity.userId);
...
//		client.setBasicAuth(SplashActivity.userId,SplashActivity.appCredentialPassword, authscope);
	...
	public void getCapabilities(View view) throws UnsupportedEncodingException{
		final String url = ServiceURL.capabilitiesURL(SplashActivity.userId);
		if (SplashActivity.userId != null) {
			AsyncHttpClient client = new AsyncHttpClient();
//			AuthScope authscope = new AuthScope(ServiceURL.serverName,ServiceURL.serverPort, AuthScope.ANY_REALM);
