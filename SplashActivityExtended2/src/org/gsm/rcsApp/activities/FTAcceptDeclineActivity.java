...
public class FTAcceptDeclineActivity extends Activity{
	...
	public void acceptFileTransferClicked(View view) throws UnsupportedEncodingException{
...
//        client.setBasicAuth(SplashActivity.userId, SplashActivity.appCredentialPassword, authscope);
	...
	public void declineFileTransferClicked(View view) throws UnsupportedEncodingException{
